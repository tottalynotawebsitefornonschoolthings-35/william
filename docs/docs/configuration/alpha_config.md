...
| `PublicKeys` | _[]string_ | PublicKeys is a list of paths pointing to public key files in PEM format use to validate JWT tokens. This option is mutually excluse with jwksURL.                                                                                                                                                                                                           |
